...
- Two Kubernetes (RKE2) clusters on Hetzner Cloud, GitOps with ArgoCD for more than 30 services, and full LGTM observability.
...
- Two Kubernetes (RKE2) clusters on Hetzner Cloud over openSUSE MicroOS, one for the app and one for data, on a segmented private network with a cluster autoscaler.
