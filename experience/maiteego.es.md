...
- Dos clusters de Kubernetes (RKE2) en Hetzner Cloud, GitOps con ArgoCD para más de 30 servicios y observabilidad LGTM completa.
...
- Dos clusters de Kubernetes (RKE2) en Hetzner Cloud sobre openSUSE MicroOS, uno para la app y otro para datos, en una red privada segmentada con cluster autoscaler.
